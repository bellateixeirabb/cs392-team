...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void btnDatabase_Click(object sender, EventArgs e)
        {
            ...
            string getMaxIdQuery = "SELECT ISNULL(MAX(Id), 0) + 1 FROM EnhancedBMI";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                connection.Open();
                newId = (int)getMaxIdCommand.ExecuteScalar();
                connection.Close();
            }

            // SQL query to insert data
            string query = "INSERT INTO EnhancedBMI (Id, Name, Weight, Height, BMI, DateTimeStamp, Gender) VALUES (@Id, @Name, @Weight, @Height, @BMI, @DateTimeStamp, @Gender)";
